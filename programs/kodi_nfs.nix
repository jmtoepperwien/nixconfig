...

{
  ...
  services.nfs.server.exports = ''
    ...
    /export/music  192.168.1.244(ro,async,insecure,all_squash,anongid=988,fsid=12)
    ...
    /export/music  192.168.1.149(ro,async,insecure,all_squash,anongid=988,fsid=12)
  '';
