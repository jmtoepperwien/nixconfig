...

{
  ...
  services.udev.extraRules = ''
    KERNEL=="hidraw*", ATTRS{idVendor}=="8d1d", ATTRS{idProduct}=="cf44", GROUP="input", MODE="0660"
    KERNEL=="hidraw*", ATTRS{idVendor}=="5043", ATTRS{idProduct}=="5442", GROUP="input", MODE="0660"
